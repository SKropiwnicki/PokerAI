...
public class PassiveBot extends Bot
{
    ...
    public PassiveBot(String name, int gold)
    {
        super(name, gold);
    }
    ...
    public void AI(List<Bot> bots, Round round)
    {
        ...
        if (round.getStage() ==Stage.PREFLOP)
        {
            ...
            else if(isLatePosition)
            {
                ...
                else if(StartingValue>=25)
                     {
                         why="Mam dobra pozycje i reke do lekkiego podbicia. Steal powinien sie udac.";
                         Bet(round.getBb()*3);
                         return;
                     }
                     else
            ...
            else if(isMediumPosition)
            {
                ...
                else if(StartingValue>=27) {why="Nie ma podbicia, wiec wejdzmy z tym"; CheckIn(); return;}
            }
        ...
        if (hasFour())
        {
            if(isFourOnTable)
            {
                ...
                else
                {
                    if (hasHighestOnHand())
                    {
                        why = "4 na stole, ale mam wysoka karte, poczekam z tym";
                        CheckIn();
                        return;
                    } else
                    {
            ...
            {
                why="Mam 4, Pasywnie cwano poczekam az oni dadza raise";
                CheckIn();
                return;
            }
        }
        ...
        else if (hasFull())
        {
            ...
            else
            {
                if(someoneRaised)
                {
                    if(round.getInValue()>goldInGame*5 && goldInGame<=400)
                    {
                        why="Wole przeczekac do dalszej fazy";
                        CheckIn();
                        return;
                    }
                    else
                    {
                        why="Mi sie nie spieszy";
                        CheckIn();
                        return;
                    }
                }
        ...
        else if (hasSuit())
        {
            ...
            else if(isFourColorsOnTable)
            {
                ...
                {
                    why="Trzeba zaczekac z tym, az zobacze dalszy rozwoj sytuacji!";
                    CheckIn();
                    return;
                }
            }
        ...
        else if(hasStraight(CardsCombos()))
        {
            ...
            else
            {
                if (someoneRaised)
                {
                    ...
                    {
                        why="Hoho. Fajna sytuacja, jeszcze poczekam i ich zrobie!";
                        CheckIn();
                        return;
                    }
                }
                ...
                {
                    why="Straight, wciagne ich w gre udajac ze nic nie mam";
                    CheckIn();
                    return;
                }
            }
        ...
        else if (hasTwoPairs())
        {
            ...
            else
            {
                ...
                {
                    why = "Dwie pary to jeszcze nic wspanialego";
                    CheckIn();
                    return;
                }
            }
        ...
        else if(hasOnePair())
        {
            ...
            else
            {
                ...
                {
                    why= "To nie jest reka do podbijania...";
                    CheckIn();
                    return;
                }
            }
