...
public class StealerPassiveBot extends Bot
{
    public StealerPassiveBot() {}

    public StealerPassiveBot(String name, int gold)
    {
        super(name, gold);
    }
    ...
    public void AI(List<Bot> bots, Round round)
    {
        ...
        {
            if(noRaiseCounter>2 && round.getBb()<round.getBb()*40)
            {
                why="Zablefuje!";
